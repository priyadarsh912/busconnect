        ...
        {!location.state?.route && !localStorage.getItem('user_route_history') && (
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-2 animate-in fade-in slide-in-from-top-4">
             <div className="flex items-center gap-3 mb-2">
               ...
               <p className="text-sm font-bold text-blue-900">Get Started tracking</p>
             </div>
             <p className="text-xs text-blue-700 leading-relaxed mb-3">
               Select one of the popular routes below to see live tracking, crowd levels, and road-calibrated ETA.
             </p>
          </div>
        )}
