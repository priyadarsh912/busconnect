...
const OutstationSearchPage = () => {
    ...
    return (
        <PageShell>
            ...
            <motion.div
                variants={fadeUp}
                className="rounded-2xl border-2 bg-orange-50 border-orange-200 dark:bg-orange-950/30 dark:border-orange-800 overflow-visible relative"
            >
                <div className="absolute top-0 left-0 right-0 h-[3px] rounded-t-2xl bg-gradient-to-r from-orange-500 to-rose-500 opacity-80" />
                ...
                <div className="p-5 space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative mt-1">
                            ...
                            <input
                                ...
                                autoComplete="off"
                                className="w-full pl-10 pr-4 py-3 bg-background/80 rounded-xl border border-border outline-none focus:ring-2 focus:ring-orange-500/20 font-semibold text-sm"
                            />
                            <AnimatePresence>
                    ...
                    >
                        <Button
                            ...
                            disabled={!canSearch}
                            className="w-full h-12 rounded-xl font-bold bg-gradient-to-r from-orange-500 to-rose-500 hover:opacity-90 transition-opacity text-white"
                        >
                            {isLoading ? (
                                "Loading Data..."
                            ) : (
                            ...
                            >
                                ...
                                {filteredRoutes.map((route, idx) => (
                                    <motion.div
                                        ...
                                        className="p-4 rounded-2xl border border-border bg-card hover:border-orange-400/40 transition-colors shadow-sm"
                                    >
                                        {/* Top row: operator + fare */}
                                        <div className="flex justify-between items-start mb-2">
                                            <div>
                                                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300 uppercase border border-orange-200 dark:border-orange-800">
                                                    {route.operator}
                                                </span>
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <Button
                                                size="sm"
                                                className="flex-1 rounded-xl text-xs font-bold bg-gradient-to-r from-orange-500 to-rose-500 text-white"
                                                onClick={() =>
